...
export default function ReportCasePage() {
  ...
  const [caseDetails, setCaseDetails] = useState<Partial<CaseDetails>>({
    status: 'รับเรื่อง', // Default status
    sensitive_data_compromised: false,
    ongoing_threat: false,
    risk_of_evidence_loss: false
  });
          ...
          <CardContent className="space-y-4 ">
            <div className="flex flex-col gap-2">
              ...
              <Input
                className="bg-white"
                id="case_number"
                placeholder="กรอกหมายเลขรับแจ้งคดี"
        ...
        <Card className="bg-[#ECEBF2]">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input className="bg-white" id="phone_number" placeholder="เบอร์โทรศัพท์" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                <label className="flex items-center gap-2">
                  ...
                  ข้อมูลอ่อนไหวรั่วไหล
                </label>
                <label className="flex items-center gap-2">
                  <Input type="radio" name="risk" className="h-4 w-4" />
                  ภัยคุกคามกำลังดำเนินอยู่
                </label>
                <label className="flex items-center gap-2">
                  <Input type="radio" name="risk" className="h-4 w-4" />
                  เสี่ยงต่อการสูญหายของพยานหลักฐาน
                </label>
              </div>
            </div>
